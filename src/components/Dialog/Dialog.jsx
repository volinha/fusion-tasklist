        ...
        <div>
            {dialogData.open && (<>
                <Dialog
                    ...
                    onClose={() => { dispatch(DialogActionsRedux.CloseDialog()) }}
                        ...
                        (<>
                            ...
                            <DialogContent>
                                <DialogContentText id="alert-dialog-description">
                                    Confirme para remover a {dialogData.module === 'task' ? "tarefa" : "tag"}.<br /> Essa ação não pode ser revertida!
                                </DialogContentText>
                            </DialogContent>
                            <DialogActions>
                                ...
                                <Button onClick={() => handleDelete(dialogData.module)} autoFocus>
                                    Sim
                                </Button>
                            </DialogActions>
                        </>)}
                            ...
                            <DialogContent>
                                <DialogContentText >
                                    {taskComment[0].comments !== '' ?
                                        <div style={{ color: '#000' }}>{taskComment[0].comments}</div>
                                        :
                                        <div style={{ color: '#AAA' }}>Não há comentários.</div>}
                                </DialogContentText>
                            </DialogContent>
                            <DialogActions>
                                <Button onClick={() => dispatch(DialogActionsRedux.CloseDialog())}>
